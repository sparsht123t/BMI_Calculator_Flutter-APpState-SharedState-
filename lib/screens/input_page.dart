import 'package:bmi_calc_vxstate/bmi_store.dart';
...
import 'package:bmi_calc_vxstate/calculator.dart';
          ...
          children: [
            Expanded(
              child: VxBuilder(
                ...
                builder: (context,BMIStore, _) => Row(
                  children: [
                    Expanded(
                      child: ReusableCard(
                ...
                children: [
                  Expanded(
                    child: VxBuilder(
                      ...
                      builder: (context,BMIStore, _) => ReusableCard(
